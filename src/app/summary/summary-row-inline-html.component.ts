  ...
  template: `
    <div>
      ...
      <bks-datatable
        ...
        [rows]="rows"
      >
        <bks-datatable-column prop="name" [summaryTemplate]="nameSummaryCell"></bks-datatable-column>
        <bks-datatable-column name="Gender" [summaryFunc]="summaryForGender"></bks-datatable-column>
        <bks-datatable-column prop="age" [summaryFunc]="avgAge"></bks-datatable-column>
      </bks-datatable>
