      ...
      <div style="width:75%;margin:0 auto">
        ...
        <div [hidden]="!tab2">
          ...
          <bks-datatable
            ...
            [scrollbarV]="true"
          >
            <bks-datatable-column name="Name" [width]="200"></bks-datatable-column>
            <bks-datatable-column name="Gender" [width]="300"></bks-datatable-column>
            <bks-datatable-column name="Age" [width]="80"></bks-datatable-column>
          </bks-datatable>
        </div>
