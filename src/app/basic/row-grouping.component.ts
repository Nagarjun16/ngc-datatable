  ...
  template: `
    <div>
      ...
      >
        ...
        <bks-datatable-group-header [rowHeight]="50" #myGroupHeader (toggle)="onDetailToggle($event)">
          <ng-template let-group="group" let-expanded="expanded" bks-datatable-group-header-template>
        ...
        </bks-datatable-group-header>

        <!-- Row Column Template -->
        <bks-datatable-column name="Exp. Pay." prop="" editable="true" frozenLeft="True">
          <ng-template
            bks-datatable-cell-template
        ...
        <bks-datatable-column name="Source" prop="source" editable="false" frozenLeft="True"></bks-datatable-column>
        <bks-datatable-column name="Name" prop="name" editable="true"></bks-datatable-column>
        <bks-datatable-column name="Gender" prop="gender"></bks-datatable-column>
        <bks-datatable-column name="Age" prop="age"></bks-datatable-column>
        <bks-datatable-column name="Comment" prop="comment">
          <ng-template
            bks-datatable-cell-template
            let-rowIndex="rowIndex"
            let-value="value"
