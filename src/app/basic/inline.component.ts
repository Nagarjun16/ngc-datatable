    ...
    <div>
      ...
      >
        <bks-datatable-column name="Name">
          <ng-template bks-datatable-cell-template let-rowIndex="rowIndex" let-value="value" let-row="row">
            <span
        ...
        <bks-datatable-column name="Gender">
          <ng-template bks-datatable-cell-template let-rowIndex="rowIndex" let-row="row" let-value="value">
            <span
              title="Double click to edit"
        ...
        <bks-datatable-column name="Age">
          <ng-template bks-datatable-cell-template let-value="value">
            {{ value }}
          </ng-template>
        </bks-datatable-column>
      </bks-datatable>
