...
@Component({
  ...
  template: `
    <bks-datatable-group-header id="t1"></bks-datatable-group-header>
    <bks-datatable-group-header id="t2">
      <ng-template bks-datatable-group-header-template></ng-template>
