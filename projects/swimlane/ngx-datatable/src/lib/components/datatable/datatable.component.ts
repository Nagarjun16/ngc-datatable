...
import { groupRowsByParents, optionalGetterForProp } from '../../utils/datatable/tree';
import { TableColumn } from '../../types/datatable/table-column.type';
import { setColumnDefaults, translateTemplates } from '../../utils/datatable/column-helper';
import { ColumnMode } from '../../types/datatable/column-mode.type';
import { SelectionType } from '../../types/datatable/selection.type';
import { SortType } from '../../types/datatable/sort.type';
import { ContextmenuType } from '../../types/datatable/contextmenu.type';
import { DataTableColumnDirective } from './../datatable/columns/column.directive';
import { DatatableRowDetailDirective } from './../datatable/row-detail/row-detail.directive';
import { DatatableFooterDirective } from './../datatable/footer/footer.directive';
import { DataTableBodyComponent } from './../datatable/body/body.component';
...
import { throttleable } from '../../utils/datatable/throttle';
import { forceFillColumnWidths, adjustColumnWidths } from '../../utils/datatable/math';
import { sortRows } from '../../utils/datatable/sort';

@Component({
  selector: 'bks-datatable',
